...
begin
  ...
  begin
    ...
    with ACursor.CurrentTangent do xangle := arctan2(y,x);
    with ACursor.CurrentCoordinate do
    begin
      if ATexture = nil then
        TextOutAngle(x,y, system.round(-xangle*1800/Pi), currentGlyphUtf8, AColor, taCenter)
      else
        TextOutAngle(x,y, system.round(-xangle*1800/Pi), currentGlyphUtf8, ATexture, taCenter);
    end;
